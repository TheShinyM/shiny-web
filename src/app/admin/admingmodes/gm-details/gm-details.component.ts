...
export class AdminGmDetailsComponent implements OnInit {
  ...
  public name: FormControl = this.formBuilder.control(null, [
    Validators.required,
  ]);
  public description: FormControl = this.formBuilder.control(null, [
    Validators.required,
  ]);
  public pictureURL: FormControl = this.formBuilder.control(null, [
    Validators.required,
  ]);
  public backgroundURL: FormControl = this.formBuilder.control(null, [
    Validators.required,
  ]);
